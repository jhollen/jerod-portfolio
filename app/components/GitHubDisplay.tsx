...
export const GitHubDisplay = () => {
  ...
  return (
    <div className={`w-full h-32 border-2 border-[#1a1a1a] rounded p-2 overflow-hidden flex flex-col font-mono text-[10px] shadow-[inset:0_2px_10px_rgba(0,0,0,0.8)] transition-all duration-500 ${themeColors.text} bg-[#050505]`}>

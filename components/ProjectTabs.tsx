  ...
  return (
    <div className="flex flex-col gap-3">
      <div
        ...
        className="flex w-full max-w-[360px] items-center gap-1 rounded-full border border-border-subtle/60 bg-white/70 p-1 shadow-subtle backdrop-blur-md"
      >
        {TABS.map((tab) => {
          ...
          return (
            <button
              ...
              className={`relative z-10 flex-1 rounded-full px-4 py-2 text-center text-sm font-medium transition-colors duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:ring-offset-white ${ringClass} ${

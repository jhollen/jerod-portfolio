...
export default function Navbar() {
  return (
    ...
    >
      <Container className="relative flex items-center justify-between gap-6 rounded-full border border-white/30 bg-white/10 px-6 py-3 text-sm shadow-[0_25px_65px_rgba(15,27,45,0.28)] backdrop-blur-2xl transition-all duration-300 supports-[backdrop-filter]:bg-white/15">
